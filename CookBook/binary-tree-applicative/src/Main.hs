...
main = do
  ...
  putStrLn
    "This property is not possible to test here, as pure produces infinite tree"
  ...
  putStrLn
    "(pure (.) <*> pure square <*> pure double <*> intTree1) == (pure square <*> (pure double <*> intTree1))"
  print
    $  (pure (.) <*> pure square <*> pure double <*> intTree1)
